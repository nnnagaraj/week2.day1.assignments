...
public class FindAccount {
	...
	public static void main(String[] args) {
	    ...
	    String text = driver.findElement(By.xpath("//span[text()='Account Name']")).getText();
	    //String text = driver.findElement(By.xpath("//input[@value='Credit Limited Account']")).getText();
	    //String text = driver.findElement(By.xpath(("//table[@id='ext-gen583']/tbody[1]/tr[1]/td[2]/input[1]"))).getText();
